...
//  ผลลัพธ์ของโปรแกรมคือการแสดงลูกบอลสีน้ำเงินที่เคลื่อนที่ในกล่องดำ โดยสะท้อนเมื่อชนขอบของกล่อง
// และข้อมูลเกี่ยวกับตำแหน่งและความเร็วของลูกบอลจะปรากฏที่ด้านล่างของหน้าต่าง. 
// การใช้ Thread ทำให้เกมสามารถทำงานพร้อมกับการรับคำสั่งจากผู้ใช้ได้โดยไม่ต้องรอให้กำลังเสร็จก่อน 
// และเกมจะต่อสู้ได้เรื่อย ๆ อย่างไม่มีสิ่งมีชีวิตในแพลตฟอร์มอื่น ๆ